package com.example.demo.serve.controller;
...
public class ServeController {
    ...
    @ApiOperation(value = "保存修改Serve信息")
    @RequestMapping(method = RequestMethod.POST, value = "/save")
    public Result addOrUpdate(@RequestBody Serve serve) {
    ...
    public Result list(){
        ...
        result.setData(serveService.list());
        return result;
    }
    ...
    public Result page( Integer pageNum,Integer pageSize ){
        ...
        result.setData(serveService.page(pageNum,pageSize));
        return result;
    }
