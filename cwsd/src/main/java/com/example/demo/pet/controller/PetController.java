...
public class PetController {
    ...
    @ApiOperation(value = "保存修改Pet信息")
    @RequestMapping(method = RequestMethod.POST, value = "/save")
    public Result addOrUpdate(@RequestBody Pet pet) {
    ...
    public Result list(){
        ...
        result.setData(petService.list());
        return result;
    }
    ...
    public Result page( Integer pageNum,Integer pageSize ){
        ...
        result.setData(petService.page(pageNum,pageSize));
        return result;
    }
